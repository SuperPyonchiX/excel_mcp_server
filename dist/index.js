...
const openWorkbookPaths = new Set();
...
// ワークブックを閉じる
async function closeWorkbook(filePath) {
    try {
        validateFilePath(filePath);
        // キャッシュから削除
...
// 開いているワークブック一覧
async function listOpenWorkbooks() {
    try {
